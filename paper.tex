...
\begin{enumerate}
 ...
 \item To apply PSO for implementing comprehensive awareness automated semantic web service composition. PSO sorts out an optimised service queue as a indirect representation of web service composition with consideration of comprehensive quality, and this service queue is further decoded using graph building algorithm to generate a final solution.
  
 \item To explore the performance of comprehensive quality awareness semantic web service composition, we utilise benchmark datasets from Web Services Challenge 2009 (WSC09) \cite{kona2009wsc}.
\end{enumerate}
