...
We herein give formal definitions of the concepts regarding the semantic web service composition problem utilised in our approach that consists of three main concepts: a semantic web service model, a weighted DAG composition model, and QoS calculation model.
