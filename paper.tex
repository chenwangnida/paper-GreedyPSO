...
\hline
\multicolumn{2}{|l|}{} & Comprehensive-aware & QoS-aware &  $\Delta Q$\\ \hline
\multirow{2}{*}{e1} &$q(e_{mt})$        &        1   &  1 &0\\ \cline{2-5} 
                    & $q(e_{s})$                    &     1      & 1& 0\\ \hline
\multirow{2}{*}{e2} & $q(e_{mt})$                     &    0.9167       & 0.75 & \\ \cline{2-5} 
                    &   $q(e_{s})$                    &   0.9630        & 0.9232 &\\ \hline
\multirow{2}{*}{e3} &  $q(e_{mt})$                   &    0.8333       & 0.75 &\\ \cline{2-5} 
                    &   $q(e_{s})$                    &    0.9608       &  0.8230 &\\ \hline
\multirow{2}{*}{e4} & $q(e_{mt})$                      &    0.875       & 0.75 &\\ \cline{2-5} 
                    &  $q(e_{s})$                     &    0.9167       & 0.9090 &\\ \hline
\multicolumn{2}{|l|}{SM} &                     &           &  \\ \hline
\multicolumn{2}{|l|}{QoS} &        0.4915             &  0.4949         &  \\ \hline
\end{tabular}
\end{table}
